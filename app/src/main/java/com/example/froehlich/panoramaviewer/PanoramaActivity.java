package com.example.froehlich.panoramaviewer;
...
public class PanoramaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Zoom
        panoWidgetView.setScaleX(1);
        panoWidgetView.setScaleY(1);
        panoWidgetView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                panoWidgetView.setScaleX(10);
                panoWidgetView.setScaleY(10);
            }
        });
    ...
    private void handleIntent(Intent intent) {
        ...
        backgroundImageLoaderTask.execute(android.util.Pair.create(fileUri, panoOptions));
    }

    private void scale(){
        if (panoWidgetView.getScaleX() <= 5) {
            panoWidgetView.setScaleX(panoWidgetView.getScaleX() + 1);
            panoWidgetView.setScaleX(panoWidgetView.getScaleX() + 1);
        } else {
            panoWidgetView.setScaleX(1);
            panoWidgetView.setScaleY(1);
     ...
     */
    class ImageLoaderTask extends AsyncTask<android.util.Pair<Uri, VrPanoramaView.Options>, Void, Boolean> {

        /**
         * Reads the bitmap from disk in the background and waits until it's loaded by pano widget.
         */
        @Override
        protected Boolean doInBackground(android.util.Pair<Uri, VrPanoramaView.Options>... fileInformation) {
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    PanoramaActivity.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG).show();
